"""solo_khakaton URL Configuration
...
from twister.views import PublicationViewSet, CommentViewSet, LikesView, AddStarRatingView, FavoritesViewSet
...
router.register('favorite', FavoritesViewSet, 'favorites')
